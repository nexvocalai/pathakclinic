      ...
      <div className="container mx-auto px-4 py-12 md:px-6 md:py-16">
            ...
            <div className="flex items-center gap-3 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-all hover:bg-[var(--color-gold)] hover:text-white"
                >
                  {social.icon}
                </a>
              ))}
              ...
              <div className="space-y-2">
                {quickLinks1.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="block text-sm text-white/60 transition-colors hover:text-[var(--color-gold)]"
                  >
                    {link.label}
                  </Link>
                ))}
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-xs text-white/40">(WhatsApp Available)</span>
                </div>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="mt-10 border-t border-white/10 pt-8">
          <p className="text-center text-sm text-white/40">
            &copy; {new Date().getFullYear()} Pathak Homoeopathic Clinic. All rights
            reserved.
          </p>
        </div>
      </div>
